...
class MyTestCase(unittest.TestCase):
    def test_search_by_job_title(self):
        ...
        wait.until(expected_conditions.element_located_to_be_selected([By.CSS_SELECTOR, '#empsearch_job_title [value="38"]']))
        ...
        wait.until(expected_conditions.visibility_of_all_elements_located((By.LINK_TEXT, 'Logout')))
